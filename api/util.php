...
function status(int $code): string {
	return match($code) {
		...
		400 => 'Bad Request', // O SERVIDOR NÃO ENTENDEU A SOLICITAÇÃO DEVIDO A SINTAXE INVÁLIDA
		...
		413 => 'Payload Too Large', // A REQUISIÇÃO É MAIOR DO QUE OS LIMITES DEFINIDOS PELO SERVIDOR
