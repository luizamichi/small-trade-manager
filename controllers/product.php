...
function filter(string $method='GET'): array {
	...
	$array['unity'] = filter_input($method, 'unity', FILTER_SANITIZE_STRING);

	$array['gross_price'] = filter_input($method, 'gross-price', FILTER_SANITIZE_STRING);
	$array['gross_price'] = str_replace(',', '.', str_replace('.', '', $array['gross_price']));
	$array['gross_price'] = is_numeric($array['gross_price']) ? $array['gross_price'] : null;

	$array['net_price'] = filter_input($method, 'net-price', FILTER_SANITIZE_STRING);
	$array['net_price'] = str_replace(',', '.', str_replace('.', '', $array['net_price']));
	...
	$array['weigth'] = filter_input($method, 'weigth', FILTER_SANITIZE_STRING);
	$array['weigth'] = str_replace(',', '.', str_replace('.', '', $array['weigth']));
