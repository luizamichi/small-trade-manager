(function (global, factory) {
	...
	class Animator {
		...
		running(chart) {
			...
			const anims = this._charts.get(chart);
			return !(!anims?.running || !anims.items.length);
		}
		stop(chart) {
			const anims = this._charts.get(chart);
	...
	const FONT_STYLE = new RegExp(/^(normal|italic|initial|inherit|unset|(oblique( -?\d?\ddeg)?))$/);
	...
	let platforms = /*#__PURE__*/Object.freeze({
		__proto__: null,
