	...
	<div class="container mb-5" id="content">
		...
		<div class="row">
			...
			<?php if($tuple->permission->client): ?>
			<div class="col-md-2">
				<p class="text-justify">Clientes</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->purchase): ?>
			<div class="col-md-2">
				<p class="text-justify">Compras</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->provider): ?>
			<div class="col-md-2">
				<p class="text-justify">Fornecedores</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->employee): ?>
			<div class="col-md-2">
				<p class="text-justify">Funcionários</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->setting): ?>
			<div class="col-md-2">
				<p class="text-justify">Opções</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->budget): ?>
			<div class="col-md-2">
				<p class="text-justify">Orçamentos</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->product): ?>
			<div class="col-md-2">
				<p class="text-justify">Produtos</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->record): ?>
			<div class="col-md-2">
				<p class="text-justify">Registros</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->report): ?>
			<div class="col-md-2">
				<p class="text-justify">Relatórios</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->service): ?>
			<div class="col-md-2">
				<p class="text-justify">Serviços</p>
			</div>
			<?php endif; ?>
			<?php if($tuple->permission->sale): ?>
			<div class="col-md-2">
				<p class="text-justify">Vendas</p>
			</div>
			<?php endif; ?>
		</div>
		<!--/ DADOS DO FUNCIONÁRIO -->
