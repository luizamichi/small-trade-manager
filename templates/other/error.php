...
<body>
	<div class="container">
		<div class="text-center">
			...
			<p class="lead">A página solicitada não foi encontrada, tente verificar se o URL que está acessando é válido ou <a class="text-white" href="<?=BASE_URL?>">clique aqui</a> para ser redirecionado para o início.</p>
			<!--/ TEXTO DE INFORMAÇÃO -->
		</div>
	</div>
</body>
